  ...
  if (cartCount() === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] text-center px-4">
        ...
        <button
          onClick={() => navigate("/")}
          className="bg-primary text-white px-8 py-2 rounded shadow-sm hover:bg-primary/90 transition"
        >
          Shop Now
        </button>
      </div>
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
        ...
        <div className="mb-6">
          ...
          {paymentOption === "Online" && (
            <div className="mt-3 p-3 border border-gray-300 rounded bg-white space-y-2">
              <p className="text-sm text-gray-700">
                Scan the QR to pay via UPI. After payment, click "Place Order".
              </p>
              <img
                src={`${"https://api.qrserver.com/v1/create-qr-code/?size=180x180&data="}${encodeURIComponent(
                  `upi://pay?pa=example@upi&pn=Siva Honey Farm&cu=INR&am=${
